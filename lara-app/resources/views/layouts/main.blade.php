    ...
    ***********************************-->
    <div id="main-wrapper">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    <img src="{{ Avatar::create(Auth::user()->name)->toBase64() }}" alt="" width="20">
                                    @else
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a class="has-arrow" href="{{ route('user.table') }}" aria-expanded="false">User Table</a>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('product') }}">Product</a></li>
                             ...
                             <li><a href="{{ route('varition') }}">Product Variation</a></li>
                             <li><a href="{{ route('size') }}">Product Size</a></li>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="http://dexignzone.com/" target="_blank">Mominul</a> 2023</p>
            </div>
        </div>
        <!--**********************************
            Footer end
