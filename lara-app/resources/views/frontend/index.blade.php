    ...
    <div class="container">
        ...
        <div class="featured-categorie-slider owl-carousel">
           ...
           <div class="featured-item">
            ...
            <div class="mt-5 text">
                <h2>
                    @if(Str::length($category->category_name >40))
                    <a title="{{ $category->category_name }}" href="{{ route('category.product',$category->id) }}">{{ Str::substr($category->category_name,0,12).'...' }}</a>
                    @else
                    <a title="{{ $category->category_name }}" href="{{ route('category.product',$category->id) }}">{{ $category->category_name }}</a>
                    @endif
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                <div class="product-item">
                    <div class="image">
                        <img width="100%" height="250px" src="{{ asset('uploads/product/preview/') }}/{{ $product->preview }}" alt="">
...
<section class="themart-trendingproduct-section section-padding">
    <div class="container">
        ...
        <div class="trendin-slider owl-carousel">
           ...
           <div class="product-item">
            <div class="image">
                <img width="100%" height="350px" src="{{ asset('uploads/product/preview/') }}/{{ $product->preview }}" alt="">
                <div class="tag new">New</div>
            </div>
            <div class="text">
