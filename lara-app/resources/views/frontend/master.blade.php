                        ...
                        <div class="col-lg-4 col-12">
                            <div class="middle-right">
                                <ul>
                                    ...
                                    <li>
                                        @auth('customer')
                                        <a href=""><i class="fi flaticon-user-profile"></i><span>{{ Auth::guard('customer')->user()->fname }}</span></a>
                                        @else
                                        <a href="{{ route('frontends.login') }}"><i class="fi flaticon-user-profile"></i><span>Login</span></a>
